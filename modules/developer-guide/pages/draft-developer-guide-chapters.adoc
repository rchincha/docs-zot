...
- The `binary-minimal` option builds the minimal distribution-spec conformant zot
...
Delve is a powerful open-source debugger for the Go programming language.
Downloads and documentation for Delve are available on GitHub
